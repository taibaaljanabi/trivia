...
export const setURL = (cat, level, token) => {
    ...
    if (category !== 9 && level !== 'any'){
        return {url: `https://opentdb.com/api.php?amount=10&category=${category}&type=boolean&encode=url3986&difficulty=${level}`}
    }

}
//https://opentdb.com/api.php?amount=10&category=13&difficulty=medium&type=boolean&encode=base64